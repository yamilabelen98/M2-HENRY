...
// Tu código acá:
var gato = document.querySelector('#createdBy');
gato.innerHTML += "Yamila";
...
function buildToDos(toDos) {
  // Tu código acá:
return toDos.map(buildToDo);//pq devuelve el elemento y el indice
}
...
var tarea= new ToDo(toDoInput.value);
if(toDoInput.value){
  toDoItems.push(tarea);
  toDoInput.value = "";
}else {
  alert("Debes ingresar almenos 1 caracter");
}
displayToDos();
}
